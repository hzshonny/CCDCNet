...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # for displays
        parser.add_argument('--display_freq', type=int, default=1e5, help='frequency of showing training results on '
                                                                       'screen') # 500  5000
        parser.add_argument('--print_freq', type=int, default=100, help='frequency of showing training results on console')
        parser.add_argument('--save_latest_freq', type=int, default=5000, help='frequency of saving the latest results')
        parser.add_argument('--save_epoch_freq', type=int, default=20, help='frequency of saving checkpoints at the end of epochs') #10
        # for training
        ...
        parser.add_argument('--novgg_featpair', type=float, default=10.0,
                            help='in no vgg setting, use pair feat loss in domain adaptation')
        self.isTrain = True
        return parser
