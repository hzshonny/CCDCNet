...
if __name__ == '__main__':
    ...
    fake_imgs = get_image("./output/fake")
    real_imgs = get_image("./output/real")
    evaluate_metrics(fake_imgs, real_imgs, 2, minibatch_size=20, metrics=['swd']) # 20
...
'''python cal_sliced_wasserstein.py'''
