...
class Dataset_(torch.utils.data.Dataset):
    def __init__(self, folder, dataset_mode):
        ...
        if dataset_mode == 'ade20k':
            ...
            #'/mnt/blob/Dataset/ADEChallengeData2016/images/validation'
            self.img_folder = './output/real'
            # '/mnt/blob/Dataset/ADEChallengeData2016/images/validation'
            ...
            self.label_folder = './all_parts_except_glasses'
            self.img_folder = './CelebAMask-HQ/CelebA-HQ-img'
            fd = open('.CelebAMask-HQ/val.txt')
            ...
            self.label_folder = './checkpoints/metfaces/test/label'
            self.img_folder = './checkpoints/metfaces/test/real'
            imgs_name = os.listdir(self.folder)
        elif dataset_mode =='aahq':
            self.label_folder = './DynaST_MCLspade_aahq/checkpoints/aahq/test/label'
            self.img_folder = './DynaST_MCLspade_aahq/checkpoints/aahq/test/real'
...
if __name__ == '__main__':
    ...
    dataset_mode = 'ade20k' #'metfaces'
    use_cos = 'cos'
    dataset = Dataset_(fake_path, dataset_mode)
    print('--load---')
    value = { 'r12': [], 'r22': [], 'r32': [], 'r42': [], 'r52': []} # 'r00': [],
...
#python sc_vgg_metric.py ./output/test_per_img/ade20k_vae_v100 ade20k
'''python sc_vgg_metric.py'''
